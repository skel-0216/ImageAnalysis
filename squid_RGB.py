...
'''
'''
path_acc03 = [path_maker('squid#1', 'stage02', 'body', 'bright', '00'),
              path_maker('squid#1', 'stage02', 'body', 'bright', '01'),
              path_maker('squid#1', 'stage02', 'body', 'bright', '02'),
              path_maker('squid#1', 'stage02', 'body', 'bright', '03'),
              path_maker('squid#1', 'stage02', 'body', 'bright', '04')]
              
save_rgb_hist_accumulate(path_acc01, 'result/acc02_body_bright')
'''
'''
